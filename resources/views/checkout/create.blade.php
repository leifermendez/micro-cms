                        ...
                        <tr>
                            <td>
                                <div class="cell example example1">
                                    <div class="">
                                        ...
                                        <div class="col-sm-4 col-md-3 side-content">
                                            <div class="bs-vertical-wizard">
                                                <ul>
                                                    <li class="complete">
                                                        <a href="#" class="text-align-left">Seleccionar Producto <i class="ico fa fa-check ico-green"></i>
                                                            <span class="desc">Ya tienes el producto deseado.</span>
                                                        </a>
                                                    </li>
                                                    <li class="current text-align-left">
                                                        <a href="#">Pago
                                                            <span class="desc">Puedes realizar tu pago con tarjeta de debito o credito.</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#" class="text-align-left">Agente
                                                            <span class="desc">Un agente autorizado se asignara y llevara tu proceso.</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <hr>
                                    <form id="form_pay" data-id="service">
