                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($products as $product)
                                            <tr>
                                                ...
                                                <td>{{$product->href}}</td>
                                                <td>
                                                    <a href="{{url('admin/products')}}/{{$product->id}}" data-method="DELETE"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <input type="text" required name="title" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Sub titulo</label>
                                        <div class="form-group">
                                            <input type="text" required name="subtitle" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Precio</label>
                                        <div class="form-group">
                                            <input type="text" required name="price" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Descripcion corta</label>
                                        <div class="form-group">
                                            <input type="text" required name="short_description" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Descripcion</label>
                                        <div class="form-group">
                                            <input type="text" required name="description" class="form-control" id="input-Default">
                                        </div>
