    ...
    <div class="page-content">
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3 class="breadcrumb-header">Ads</h3>
            </div>
            <div id="main-wrapper">
                <div class="row">
                    <div class="col-md-12">
                        <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal"  style="margin-bottom: 10px" class="btn btn-primary">Nuevo</a>
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($ads as $ad)
                                            <tr>
                                                ...
                                                <td><a href="{{url('admin/ads/'.$ad->id)}}/edit">{{$ad->name}}</a></td>
                                                <td><img src="{{$ad->image}}" width="50" alt=""></td>
                                                <td><a href="{{$ad->href}}">{{$ad->href}}</a></td>
                                                <td>{{$ad->continent}}</td>
                                                <td>{{$ad->currency}}</td>
                                                <td>
                                                    <a href="{{url('admin/ads')}}/{{$ad->id}}" data-method="DELETE"
                            ...
                            <form action="{{url('admin/ads')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <input type="text" required name="image" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Link</label>
                                        <div class="form-group">
                                            <input type="text" required name="href" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Continente</label>
                                        <div class="form-group">
                                            <input type="text" required maxlength="2" name="continent" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Divisa</label>
                                        <div class="form-group">
                                            <input type="text" required name="currency" class="form-control" id="input-Default">
                                        </div>
                                    </div>
