    ...
    <div class="page-content">
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3 class="breadcrumb-header">Plantillas</h3>
            </div>
            <div id="main-wrapper">
                <div class="row">
                    <div class="col-md-12">
                        <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal"  style="margin-bottom: 10px" class="btn btn-primary">Enviar</a>
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($templates as $template)
                                            <tr>
                                                ...
                                                <td><a href="{{url('admin/templates/'.$template->id)}}/edit">{{$template->name}}</a></td>
                                                <td>
                                                    <a href="{{url('admin/templates')}}/{{$template->id}}" data-method="DELETE"
                    ...
                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog">
                            <form action="{{url('admin/templates')}}/send" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                        <h4 class="modal-title" id="myModalLabel">Enviar Mail</h4>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <input type="email" required name="to" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Nombre</label>
                                        <div class="form-group">
                                            <input type="text" required name="name" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Web</label>
                                        <div class="form-group">
                                            <input type="text" required name="web" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Plantilla</label>
                                        <div class="form-group">
                                            <select name="id_template" required class="form-control" id="">
                                                @foreach($templates as $template )
                                        ...
                                        <div class="form-group">
                                            <input type="file" name="attachments" class="form-control" id="input-Default">
                                        </div>
                                        <p class="text-muted">
                                            El sistema enviara un mail con archivos adjuntos.
                                        </p>
                                    </div>
