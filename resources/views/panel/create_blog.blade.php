...
@section('content')
    <div class="page-content">
        ...
        <div class="page-inner">
            <form class="form-horizontal" action="{{url('admin/blog')}}" method="POST">
                {{csrf_field()}}
                <div class="form-group">
                    <label for="input-Default" class="col-sm-2 control-label">Titulo</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="title" id="input-Default">
                    </div>
                </div>
                <div class="form-group">
                    <label for="input-help-block" class="col-sm-2 control-label">Sub titulo</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="subtitle" id="input-help-block">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="service" id="">
                            ...
                            @foreach($services as $service)
                                <option value="{{$service->id}}">{{$service->title}} ({{number_format($service->price,2)}})</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control ckeditor" name="description" id="" cols="30" rows="14"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="input-Default" class="col-sm-2 control-label">Image</label>
                    <div class="col-sm-10">
                        <input type="text" value="" class="form-control" name="image" id="input-Default">
                    </div>
                </div>
                <div class="form-group">
