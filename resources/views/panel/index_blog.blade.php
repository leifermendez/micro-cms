    ...
    <div class="page-content">
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3 class="breadcrumb-header">Blogs</h3>
            </div>
            <div id="main-wrapper">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{url('admin/blog/create')}}" class="btn btn-primary" style="margin-bottom: 10px">Nuevo</a>
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($blogs as $blog)
                                            <tr>
                                                ...
                                                <th scope="row"><a href="{{url('admin/blog/')}}/{{$blog->id}}/edit">{{$blog->title}}</a></th>
                                                <th scope="row">{{$blog->subtitle}}</th>
                                                <th scope="row">{{$blog->service}}</th>
                                                <th scope="row"><a href="{{url('blog/')}}/{{$blog->id}}" target="_blank">Ver</a></th>
