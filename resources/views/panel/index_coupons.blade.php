    ...
    <div class="page-content">
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3 class="breadcrumb-header">Cupones</h3>
            </div>
            <div id="main-wrapper">
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($coupons as $coupon)
                                            <tr>
                                                ...
                                                <td><a href="{{url('admin/coupons/'.$coupon->id)}}/edit">{{$coupon->code}}</a></td>
                                                <td>{{$coupon->amount}}</td>
                                                <td>{{$coupon->type}}</td>
                                                <td>{{$coupon->status}}</td>
                                                <td>{{$coupon->use_coupons}}/{{$coupon->limit}}</td>
                                                <td>{{$coupon->updated_at}}</td>
                                                <td>
                                                    <a href="{{url('admin/coupons')}}/{{$coupon->id}}" data-method="DELETE"
                            ...
                            <form action="{{url('admin/coupons')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Crear cupon</h4>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <input type="text" required name="code" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Limite de uso</label>
                                        <div class="form-group">
                                            <input type="text" required name="limit" class="form-control" id="input-Default">
                                        </div>
                                        <label for="">Valor</label>
                                        <div class="form-group">
                                            <input type="text" required name="amount" class="form-control" id="input-Default">
                                        </div>
