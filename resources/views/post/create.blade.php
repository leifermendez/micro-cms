                        ...
                        <div class="card-body">
                            <div id="list_options">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="icon" value="" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Valor">

                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nombre Vinculo</label>
                                    <input type="text" class="form-control" name="link_name" value="" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Valor">
